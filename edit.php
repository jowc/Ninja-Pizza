...
<head>
    ...
    <title> <?php echo "Edit Pizza" ?> </title>
</head>
    ...
    <div class="w-full my-32">
        <div class="max-w-5xl mx-auto">
            <form action="add.php" method="GET" class="bg-gray-200 py-12 px-8 capitalize text-center rounded-lg shadow w-9/12 mx-auto">
                ...
                <div class="mt-6">
                    <input type="text" id="title" name="title" value="<?php echo '' ?>" placeholder="Ingredient title*" class=" pl-3 py-3 shadow rounded w-6/12" required>
                </div>
                <div class="mt-4">
                    <input type="text" id="Ingredient" name="Ingredient" value="<?php echo '' ?>" placeholder="Ingredients eg maize, rice*" class=" pl-3 py-3 shadow rounded w-6/12" required>
                </div>
                <div class="mt-6">
                    <button name="button" class=" px-4 py-2 shadow rounded antialiased">Update Pizza</button>
                </div>
                <div class="mt-4">
